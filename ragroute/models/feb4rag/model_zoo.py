...
from ragroute.models.feb4rag.custom_models import AnglEModel, E5Model, SentenceTransformerSpec, InstructorModel
from ragroute.models.feb4rag.model_collection import ModelClass
...
class BeirModels(ModelClass):
    def __init__(self, model_dir, old_models_only=False, special_token=False,
        ...
        #print("BeirModels -> specific_model:", specific_model)
        #print("BeirModels -> self.names:", self.names)
